...
human_df = pd.read_csv("./datasets/train/split/extended/train_set_human_extended.csv")
ai_df = pd.read_csv("./datasets/train/split/extended/train_set_ai_extended.csv")
...
df.to_csv("./datasets/train/train_set_final.csv", index=False)  # 결과 저장